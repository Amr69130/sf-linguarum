 ...
 */
final class Version20250424165439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE language ADD CONSTRAINT FK_D4DB71B5727ACA70 FOREIGN KEY (parent_id) REFERENCES language (id)
        SQL);
    }
