 ...
 */
final class Version20250510092134 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE language ADD CONSTRAINT FK_D4DB71B5727ACA70 FOREIGN KEY (parent_id) REFERENCES language (id) ON UPDATE NO ACTION ON DELETE NO ACTION
        SQL);
        $this->addSql(<<<'SQL'
